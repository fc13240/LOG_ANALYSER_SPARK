        ...
        try {
            ...
            if ("局域网".equals(country)) {
                ...
                if (index > 0) {
                    ...
                    } else if (flag.equals("广西") || flag.equals("西藏") || flag.equals("宁夏") || flag.equals("新疆")) {
                        info.setCountry("中国");
                    ...
                    } else if (flag.equals("上海") || flag.equals("北京") || flag.equals("天津") || flag.equals("重庆")) {
                        info.setCountry("中国");
                    ...
                    } else if (flag.equals("香港") || flag.equals("澳门")) {
                        info.setCountry("中国");
